    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                ...
                style={styles.button}
            >
                <Animated.Text style={[styles.buttonText, { transform: [{ scale: scaleValue }] }]}>Нажми без useMemo</Animated.Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
                ...
                style={styles.button}
            >
                <Animated.Text style={[styles.buttonText, { transform: [{ scale: scaleValue }] }]}>Нажми с useMemo</Animated.Text>
            </TouchableOpacity>
        </View>
    );
};
